...
When you pass service names to `up`, `down`, or `restart`, Zapper warns for
each name that does not match a configured service or alias and continues with
the valid services in the same command.
